#require Rails.root.to_s+'/lib/authentication'
    ...
    class PartnersController < ApplicationController
      ...
      # GET /partners.json
       ...
       before_filter :user_admin? , :except=> [:index , :show] 

      def index
        @reading_partners = Partner.find_all_by_partner_type('Reading')
        @dining_partners =  Partner.find_all_by_partner_type('Dining')
