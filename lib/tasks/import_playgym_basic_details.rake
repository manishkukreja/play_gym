namespace :initial_data do
	...
	task :activity_charges_data => :environment do
		Charge.delete_all
		Charge.create(activity_id: 1, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 2, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 3, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 4, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 5, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 6, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 7, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 8, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 9, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 10, charge: 200, freq_flag: 'DEFAULT_FLAT_200')
		Charge.create(activity_id: 11, charge: 200, freq_flag: 'DEFAULT_FLAT_200')

		Charge.create(activity_id: 12, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 13, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 14, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 15, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 16, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 17, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 18, charge: 200, freq_flag: 'PER_HR_200')
		Charge.create(activity_id: 19, charge: 200, freq_flag: 'PER_HR_200')

		Charge.create(activity_id: 15, charge: 800, freq_flag: 'SUMMER_1_PER_HR_PER_WEEK')
		Charge.create(activity_id: 16, charge: 600, freq_flag: 'SUMMER_1_PER_HR_PER_WEEK')
		Charge.create(activity_id: 17, charge: 1000, freq_flag: 'SUMMER_1_PER_HR_PER_WEEK')
		Charge.create(activity_id: 18, charge: 800, freq_flag: 'SUMMER_1_PER_HR_PER_WEEK')

		Charge.create(activity_id: 15, charge: 1500, freq_flag: 'SUMMER_2_PER_HR_PER_WEEK')
		Charge.create(activity_id: 16, charge: 1000, freq_flag: 'SUMMER_2_PER_HR_PER_WEEK')
		Charge.create(activity_id: 17, charge: 2000, freq_flag: 'SUMMER_2_PER_HR_PER_WEEK')
		Charge.create(activity_id: 18, charge: 1500, freq_flag: 'SUMMER_2_PER_HR_PER_WEEK')

		Charge.create(activity_id: 15, charge: 2000, freq_flag: 'SUMMER_3_PER_HR_PER_WEEK')
		Charge.create(activity_id: 16, charge: 1500, freq_flag: 'SUMMER_3_PER_HR_PER_WEEK')
		Charge.create(activity_id: 17, charge: 2500, freq_flag: 'SUMMER_3_PER_HR_PER_WEEK')
		Charge.create(activity_id: 18, charge: 2000, freq_flag: 'SUMMER_3_PER_HR_PER_WEEK')

		Charge.create(activity_id: 1, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 2, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 3, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 4, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 5, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 6, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 7, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 8, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 9, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 10, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')
		Charge.create(activity_id: 11, charge: 2000, freq_flag: 'DEFAULT_FLAT_2000')

		Charge.create(activity_id: 12, charge: 2500, freq_flag: 'MEMBER_3_PER_WEK')
		Charge.create(activity_id: 13, charge: 2500, freq_flag: 'MEMBER_3_PER_WEK')
		Charge.create(activity_id: 14, charge: 2500, freq_flag: 'MEMBER_3_PER_WEK')

		Charge.create(activity_id: 12, charge: 3000, freq_flag: 'MEMBER_4_PER_WEK')
		Charge.create(activity_id: 13, charge: 3000, freq_flag: 'MEMBER_4_PER_WEK')
		Charge.create(activity_id: 14, charge: 3000, freq_flag: 'MEMBER_4_PER_WEK')

		Charge.create(activity_id: 12, charge: 3500, freq_flag: 'MEMBER_5_PER_WEK')
		Charge.create(activity_id: 13, charge: 3500, freq_flag: 'MEMBER_5_PER_WEK')
		Charge.create(activity_id: 14, charge: 3500, freq_flag: 'MEMBER_5_PER_WEK')

		Charge.create(activity_id: 15, charge: 400, freq_flag: 'MEMBER_SUMMER_1_PER_WEEK')
		Charge.create(activity_id: 16, charge: 400, freq_flag: 'MEMBER_SUMMER_1_PER_WEEK')
		Charge.create(activity_id: 17, charge: 750, freq_flag: 'MEMBER_SUMMER_1_PER_WEEK')
		Charge.create(activity_id: 18, charge: 500, freq_flag: 'MEMBER_SUMMER_1_PER_WEEK')
		Charge.create(activity_id: 19, charge: 500, freq_flag: 'MEMBER_SUMMER_1_PER_WEEK')

		Charge.create(activity_id: 15, charge: 800, freq_flag: 'MEMBER_SUMMER_2_PER_WEEK')
		Charge.create(activity_id: 16, charge: 800, freq_flag: 'MEMBER_SUMMER_2_PER_WEEK')
		Charge.create(activity_id: 17, charge: 1500, freq_flag: 'MEMBER_SUMMER_2_PER_WEEK')
		Charge.create(activity_id: 18, charge: 1000, freq_flag: 'MEMBER_SUMMER_2_PER_WEEK')
		Charge.create(activity_id: 19, charge: 1000, freq_flag: 'MEMBER_SUMMER_2_PER_WEEK')

		Charge.create(activity_id: 15, charge: 1200, freq_flag: 'MEMBER_SUMMER_3_PER_WEEK')
		Charge.create(activity_id: 16, charge: 1200, freq_flag: 'MEMBER_SUMMER_3_PER_WEEK')
		Charge.create(activity_id: 17, charge: 2000, freq_flag: 'MEMBER_SUMMER_3_PER_WEEK')
		Charge.create(activity_id: 18, charge: 1500, freq_flag: 'MEMBER_SUMMER_3_PER_WEEK')
		Charge.create(activity_id: 19, charge: 1500, freq_flag: 'MEMBER_SUMMER_3_PER_WEEK')
	end
